package week_7_Task.utils;

import java.io.*;
import java.net.Socket;

import static week_7_Task.common.SimpleHttpServer.HTML_FILE_PATHS;
import static week_7_Task.common.SimpleHttpServer.JSON_FILE_PATHS;
...
public class HttpHandler implements  Runnable{
    ...
    private void sendNewNotFoundResponse(PrintWriter output) {
        output.println("HTTP/1.1 434 Not Found");
        output.println("Content-type: text/plain");
        output.println();
        output.println("404 Not Found - The required resource was not found on this server");
    }
